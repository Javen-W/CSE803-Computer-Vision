...
def b6(t):
    ...
    return t[0].astype(float) / t[1].astype(float)
...
def b17(M):
    ...
    return M.sum(axis=1, keepdims=False)
...
def b18(M):
    ...
    return M.sum(axis=0, keepdims=False)
...
def b19(M):
    ...
    return M.sum(axis=1, keepdims=True)
...
def b20(M):
    ...
    return (M ** 2).sum(axis=1, keepdims=True) ** 0.5
